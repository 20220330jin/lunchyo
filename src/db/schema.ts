...
export const postHateCountSeq = pgSequence("post_hate_count_seq", {
    startWith: "1",
    increment: "50",
    minValue: "1",
...
export const postLikeCountSeq = pgSequence("post_like_count_seq", {
    startWith: "1",
    increment: "50",
    minValue: "1",
    maxValue: "9223372036854775807",
...
export const postSeq = pgSequence("post_seq", {
    startWith: "1",
    increment: "50",
    minValue: "1",
    maxValue: "9223372036854775807",
...
export const replyLikeCountSeq = pgSequence("reply_like_count_seq", {
    startWith: "1",
    increment: "50",
    minValue: "1",
    maxValue: "9223372036854775807",
...
export const testSeq = pgSequence("test_seq", {
    startWith: "1",
    increment: "50",
    minValue: "1",
    maxValue: "9223372036854775807",
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    check("member_member_type_check", sql`(member_type)
...
export const baseSchema = {
    id: serial('id').primaryKey(),
    delYn: char("del_yn", {length: 1}).default('N').notNull(),
...
export const restaurants = pgTable('restaurants', {
    ...baseSchema,
    kakaoPlaceId: varchar('kakao_place_id', {length: 255}).notNull().unique(),
